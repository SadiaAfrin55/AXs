...
class TechnicalCreateIssueOne extends StatefulWidget {
  const TechnicalCreateIssueOne({Key? key}) : super(key: key);

  @override
  _TechnicalCreateIssueOneState createState() => _TechnicalCreateIssueOneState();
}

class _TechnicalCreateIssueOneState extends State<TechnicalCreateIssueOne> {
          ...
          children: [
            ...
            Padding(
              ...
              child: CustomFullScreenButton(
                title: 'Next',
                onTap: (){
                  Navigator.pushNamed(context, '/TechnicalCreateIssueTwo');
                  },
              ),
            ),
          ],
